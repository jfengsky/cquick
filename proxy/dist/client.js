...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__fileList__ = __webpack_require__(15);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__fileRoute__ = __webpack_require__(0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__route__ = __webpack_require__(10);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__apis__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__apiRoute__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mockRoute__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__fileRoute__ = __webpack_require__(0);
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
/* harmony default export */ __webpack_exports__["a"] = (function (req) { return __awaiter(_this, void 0, void 0, function () {
    var reqPath, query, body, baseRouteList, routeList, _a, apiRouteData, mockRouteData, mockChangeData;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                reqPath = req.path, query = req.query, body = req.body;
                return [4 /*yield*/, Object(__WEBPACK_IMPORTED_MODULE_1__apiRoute__["a" /* default */])({
                        type: 'search'
                    })];
            case 1:
                baseRouteList = _b.sent();
                routeList = baseRouteList.map(function (item) { return item.name; });
                ...
                switch (_a) {
                    ...
                    case __WEBPACK_IMPORTED_MODULE_0__apis__["a" /* apilist */]: return [3 /*break*/, 3];
                    case __WEBPACK_IMPORTED_MODULE_0__apis__["c" /* mocklist */]: return [3 /*break*/, 5];
                    case __WEBPACK_IMPORTED_MODULE_0__apis__["b" /* mockchange */]: return [3 /*break*/, 7];
                    case '/favicon.ico': return [3 /*break*/, 9];
                }
                return [3 /*break*/, 10];
            case 2: return [2 /*return*/, 'layout.html'];
            case 3: return [4 /*yield*/, Object(__WEBPACK_IMPORTED_MODULE_1__apiRoute__["a" /* default */])(body)];
            case 4:
            ...
            case 5: return [4 /*yield*/, Object(__WEBPACK_IMPORTED_MODULE_2__mockRoute__["a" /* default */])(body)];
            case 6:
            ...
            case 7: return [4 /*yield*/, Object(__WEBPACK_IMPORTED_MODULE_3__fileRoute__["a" /* default */])(body)];
            case 8:
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_fs___default.a.writeFile(filePath(name), code, 'utf-8', function (err) {
                            console.log(err);
                            resolve(name);
                        });
                    })];
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__route_apiRoute__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__route_mockRoute__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__route_fileRoute__ = __webpack_require__(0);
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
